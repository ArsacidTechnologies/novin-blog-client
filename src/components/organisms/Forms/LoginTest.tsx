...
export interface ILoginTestProps {

}

const LoginTest: FC<ILoginTestProps> = ({ }) => {
        ...
        <div className="form-field">
          <div className="form-control justify-center">
            <a
              ...
              className="link link-underline-hover link-primary text-sm">dont have an account yet? Sign up.</a>
          </div>
        </div>
      </div>
    </div>
