...
const card = tv({
  slots: {
    base: "md:flex bg-slate-100 rounded-xl p-8 md:p-0 dark:bg-gray-900 modern:bg-purple-800",
...
export interface ICardProProps {

}
const { base, avatar, wrapper, description, infoWrapper, name, role } = card();

const CardPro: FC<ICardProProps> = ({ }) => {
  return (
    <div className=' modern:bg-purple-800 flex max-w-[400px]'>
      <figure className={base({ class: "bg-purple-100  dark:bg-purple-200" })}>
        <img className={avatar()} src="/intro-avatar.webp" alt="" width="384" height="512" />
